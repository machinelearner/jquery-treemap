    ...
    $('div#someId).treemap(
        [],
        {
            backgroundColor: function(node,box){
                ...
                //box is the dom element which represents a particular node
                return 'red'; // You should return a css valid color string. can be a hex value or the string representing colour
            },
            color: function(node){
                //node is an item of the list passed as the first arg of this fuction;
